...
public class FacPayPublicApplyController extends BaseController {
	...
	public AjaxResult addSave(FacPayPublicApply facPayPublicApply) {
		...
		if (facPayPublicApply.getId() == null) {
			...
			// 更新
			facPayPublicApply = facPayPublicApplyService
					.selectFacPayPublicApplyById(facPayPublicApply.getId());
			facPayPublicApplyService.deleteFacPayPublicApplyByIds(
					facPayPublicApply.getId() + "");
		}
	...
	@PostMapping("/addSove")
	@ResponseBody
	public AjaxResult addSove(FacPayPublicApply FacPayPublicApply)
			throws Exception {
		FacPayPublicApply.setUser(ShiroUtils.getUserId());
		FacPayPublicApply.setCreateTime(new Date());
	...
	public String editPub(@PathVariable("id") Long id, ModelMap mmap) {
		FacPayPublicDetailed facPayPublicDetailed = facPayPublicApplyService
				.selectFacPayPublicDetailedById(id);
	...
	public AjaxResult removepub(String ids) {
		return toAjax(
				facPayPublicApplyService.deleteFacPayPublicDetailedByIds(ids));
	}
