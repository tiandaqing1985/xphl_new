 ...
 * @date 2019-09-16
 */
public interface XzResourceTypeMapper 
{
	/**
     * 查询采购类型信息
     * 
     ...
     * @return 结果
     */
	public int deleteXzResourceTypeById(Long id);
	...
	public int selectXzResourceTypeByName(@Param("sourceType")Integer sourceType,@Param("name") String name);
