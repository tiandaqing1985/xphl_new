...
public class ApprovalProcessServiceImpl implements ApprovalProcessService {
    ...
    public String initializeProcessPublic(FacPayPublicApply facReimburseApply) {
        ...
        /***
         ...
         @Override public String initialize(Object o) {
         ...
         @Transactional
         @Override public String initializeProcess(FacReimburseApply facReimburseApply) {
         //财务，人事 << 2000 审批流
         //查询2级部门leader id
         try {
    ...
    public void insert(FacSysUserApproval facSysUserApproval) {
        //查询当前审批是第几步并设置上，若同一单号有两个相同的审批人，则只保留第一个
        FacSysUserApproval selectVO = new FacSysUserApproval();
        selectVO.setApplyId(facSysUserApproval.getApplyId());
