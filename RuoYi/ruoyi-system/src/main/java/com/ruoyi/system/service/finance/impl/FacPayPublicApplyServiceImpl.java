...
//        Long leaderId = iSysUserService.selectApproverIdByApplyerId(facPayPublicApply.getUser());// 所在部门负责人id
//        Long upLeaderId = iSysUserService.selectUpApproverIdByApplyerId(facPayPublicApply.getUser());// 所在部门负责人的上级leader
//        Long approvalId = 0L;// 部门负责人id 审批人
//        if (facPayPublicApply.getUser().equals(leaderId)) { // 判断用户是否部门负责人,防止自己审批自己
//            // 确定一、二级审批人id
...
//            approvalId = leaderId;
//        }
//        if (facPayPublicApply.getUser() == 103 || facPayPublicApply.getUser() == 101) {
